            ...
            >
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex flex-col gap-2">
                        <div
                            v-for="(
                                healthcheckValue, healthcheckKey
                            ) in service.healthcheck"
                            class="flex flex-col"
                        >
                            <InputGroup>
                                <InputText
                    ...
                    >
                        <InputGroup class="flex-col gap-2">
                            ...
                            <div class="flex flex-col gap-1 ml-4">
                                ...
                                <MultiSelect
                                    v-model="
                                        service.post_deploy_actions[pdaIdx]
                                            .parameters
                                    "
...
const search = (event: AutoCompleteCompleteEvent) => {
    if (!event.query.trim().length) {
        ...
        filteredShellCommands.value = shellCommands.value.filter(
            (shellCommand) => {
                return shellCommand
                    .toLowerCase()
